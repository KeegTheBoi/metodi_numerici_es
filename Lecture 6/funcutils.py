...
class FunctionApprox:
    ...
    def __init__(self, sym_expr, interval, real_alfas):
    ...
    def derivative(self, multeplicity=1):
        return self.lambda_map(sym.diff(self.sym_expr, self.x_sym, multeplicity))
    ...
    def plot_error(self, method):
        ...
        plt.semilogy(np.arange(self.i), err_abs(np.array(self.vec_xk), self.real_alfas))
